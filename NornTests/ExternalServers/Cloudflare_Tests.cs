...
namespace org.GraphDefined.Vanaheimr.Norn.Tests.NTS
{
    ...
    /// <summary>
    /// Test the NTS client against public NTS server of Cloudflare.
    /// </summary>
    [TestFixture]
    public class Cloudflare_Tests
    {

        private const String serverName = "time.cloudflare.com";


        #region TestCloudflareTime1()

        /// <summary>
        /// Test the NTS client against the public NTS server time.cloudflare.com.
        /// </summary>
        [Test]
        public async Task TestCloudflareTime1()
        {
        ...
        #region TestCloudflareTime1_RandomBitError()      <<<<<<<<<<<<< It seem's that this will not ALWAYS FAIL!?!
        ...
        /// </summary>
        [Test]
        public async Task TestCloudflareTime1_RandomBitError()
        {
        ...
        #region TestCloudflareTime1_CustomTLSCertificateValidation()
        ...
        /// </summary>
        [Test]
        public async Task TestCloudflareTime1_CustomTLSCertificateValidation()
        {
                                                 ...
                                                 RemoteCertificateValidator: (sender,
                                                                              ...
                                                                              sslPolicyErrors) => {
                                                                                  ...
                                                                                  if (serverCertificate?.Subject.Contains(serverName) == true &&
                                                                                      sans.Contains("DNS-Name=time.cloudflare.com"))
                                                                                  {
                                                                                      return (true, []);
                                                                                  }
        ...
        #region TestCloudflareTime1_CustomTLSCertificateValidation_Failed()
        ...
        /// </summary>
        [Test]
        public async Task TestCloudflareTime1_CustomTLSCertificateValidation_Failed()
        {
        ...
        #region TestCloudflareTime1_RequestSignedResponse()
        ...
        /// </summary>
        [Test]
        public async Task TestCloudflareTime1_RequestSignedResponse()
        {
