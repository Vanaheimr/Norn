...
namespace org.GraphDefined.Vanaheimr.Norn.NTS.NTSKERecords
{
    ...
    /// <summary>
    /// NTS-KE NTPv4 Port Negotiation
    /// </summary>
    public class NTPv4PortNegotiation : NTSKE_Record
    {

        /// <summary>
        /// Create a new NTS-KE NTPv4 Port Negotiation record.
        /// </summary>
        /// <param name="IsCritical">Whether an unrecognized record must cause an error.</param>
        public NTPv4PortNegotiation(Boolean IsCritical)
