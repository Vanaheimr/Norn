...
namespace org.GraphDefined.Vanaheimr.Norn.Drone.WebAPI
{
    ...
    /// <summary>
    /// The Norn Drone WebAPI.
    /// </summary>
    public partial class NornDroneWebAPI
    {
        ...
        public class WebAPILogger : HTTPServerLoggerX
        {
            ...
            /// </summary>
            public NornDroneWebAPI  WebAPI    { get; }

            #endregion

            #region Constructor(s)

            #region WebAPILogger(WebAPI, Context = DefaultContext, LogFileCreator = null)

            /// <summary>
            /// Create a new Norn Drone WebAPI logger using the default logging delegates.
            /// </summary>
            /// <param name="WebAPI">A NTS WebAPI.</param>
            /// <param name="Context">A context of this API.</param>
            /// <param name="LogFileCreator">A delegate to create a log file from the given context and log file name.</param>
            public WebAPILogger(NornDroneWebAPI          WebAPI,
                                String                   LoggingPath,
            ...
            #region WebAPILogger(WebAPI, Context, ... Logging delegates ...)

            /// <summary>
            /// Create a new Norn Drone WebAPI logger using the given logging delegates.
            /// </summary>
            /// <param name="WebAPI">A Norn Drone WebAPI.</param>
            /// <param name="Context">A context of this API.</param>
            /// 
...

            {
                ...
                this.WebAPI = WebAPI ?? throw new ArgumentNullException(nameof(WebAPI), "The given Norn Drone WebAPI must not be null!");
