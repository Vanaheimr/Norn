...
namespace org.GraphDefined.Vanaheimr.Norn.Drone.HTTPAPI
{
    ...
    /// <summary>
    /// The Norn Drone HTTP API.
    /// </summary>
    public partial class NornDroneHTTPAPI
    {

        /// <summary>
        /// The Norn Drone HTTP API logger.
        /// </summary>
        public class HTTPAPILogger : HTTPServerLoggerX
        {
            ...
            /// <summary>
            /// The linked Norn Drone HTTP API.
            /// </summary>
            public NornDroneHTTPAPI  HTTPAPI    { get; }
            ...
            /// <summary>
            /// Create a new Norn Drone HTTP API logger using the default logging delegates.
            /// </summary>
            /// <param name="HTTPAPI">A Norn Drone HTTP API.</param>
            /// <param name="Context">A context of this API.</param>
            /// <param name="LogFileCreator">A delegate to create a log file from the given context and log file name.</param>
            public HTTPAPILogger(NornDroneHTTPAPI         HTTPAPI,
                                 String                   LoggingPath,
            ...
            /// <summary>
            /// Create a new Norn Drone HTTP API logger using the given logging delegates.
            /// </summary>
            /// <param name="HTTPAPI">A Norn Drone HTTP API.</param>
            /// <param name="Context">A context of this API.</param>
            /// 
